    ...
    private class ScoreListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (tmpCourse.isDivider()) {
                ...
                mScore.setText((tmpCourse.getCreditCalculated() == 0) ? (tmpCourse.getScore() == -2 ? "重修" : "通过") : (!String.valueOf(tmpCourse.getScore()).contains(".")) ? String.valueOf(tmpCourse.getScore()) : String.valueOf(tmpCourse.getScore()).replaceAll("0*$", "").replaceAll("\\.$", ""));
            }
            return convertView;
        }
    }
