...
public class AboutFragment extends Fragment implements View.OnClickListener, Connector.Callback{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mCheckForUpdate.setOnClickListener(AboutFragment.this);
        mFeedback.setOnClickListener(AboutFragment.this);
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    new Request.Builder().progress(new Connect.Progress() {
                                        ...
                                        public void updateProgress(Long current, Long total) {
                                            ...
                                            .get(new Connector.UpdateDownloadConnector(AboutFragment.this));
                                    progressDialog.show();
                                }
